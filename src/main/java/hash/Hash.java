...
/** Constant to denote invalid hash type. */
   ...
   * @return one of the predefined constants
   */
  public static int getHashType(String hashName) {
    //String hashName =  "murmur"  or "jenkins";
    return parseHashType(hashName);
  }
   ...
   */
  public static Hash getInstance(String hashName) {
    int type = getHashType(hashName);
