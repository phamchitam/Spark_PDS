...
public class Join2Raw {

	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setAppName("Join2Raw").setMaster("local[*]");
		JavaSparkContext sc = new JavaSparkContext(conf);

		String input = "/Users/ntrieuth/Documents/input/x0.txt";
		String output = "/Users/ntrieuth/Documents/input/x0out";
		JavaRDD<String> R = sc.textFile(input);
		JavaRDD<String> L = sc.textFile(input);
